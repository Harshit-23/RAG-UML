...
def format_docs(docs, file_path="retrieved_docs.txt"):
    """Format retrieved documents and save them for debugging."""
...
def load_rag_chain(api_key, model="gpt-4o-mini"):
    ...
    vectorstore = Chroma(persist_directory=chroma_db_path, embedding_function=OpenAIEmbeddings(openai_api_key=api_key))
